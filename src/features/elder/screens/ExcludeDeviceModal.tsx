...
import { deleteDevice } from "@/features/elder/api/deleteDevice";
...
export default function ExcludeDeviceModal() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      throw new Error("Error while fetch for delete device");
    }
  };
    ...
    <Modal transparent animationType="fade" statusBarTranslucent={true}>
      <View style={styles.container}>
        <View style={styles.box}>
          ...
          <Text style={styles.title}>Deletar dispositivo?</Text>
